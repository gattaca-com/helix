...
impl FromRow for MergedBlock {
        ...
        Self: Sized,
    {
        ...
        Ok(MergedBlock {
            ...
            original_blob_count: parse_i32_to_usize(row.get::<&str, i32>("original_blob_count"))?,
            merged_blob_count: parse_i32_to_usize(row.get::<&str, i32>("merged_blob_count"))?,
            builder_inclusions,
        })
    }
