...
mod tests {
    ...
    //     // let _guard =
    //     //     helix_common::utils::init_tracing_log(&Default::default(), "",
    // Default::default());
    ...
    //         info!(%slot, %n_slots, "All peers returned the same inclusion list. Waiting until
    // next slot");         wait_until_next_slot(&chain_info).await;
    //     }
