...
/// Creates a new [`SignedBuilderBid`] (get_header_reponse) from a [`SignedBidSubmission`]. The signature is replaced with the a new using the provided signing key.
...
/// Creates a new [`SignedBuilderBid`] (get_header_reponse) from a [`SignedHeaderSubmission`] (v2 or v3 submission). The signature is replaced with the a new using the provided signing key.
