...
use helix_types::{
    ...
    sepolia_spec, spec_from_file, ChainSpec, ForkName, MainnetEthSpec, SlotClock, SlotClockTrait,
    HOLESKY_GENESIS_TIME, MAINNET_GENESIS_TIME, SECONDS_PER_SLOT, SEPOLIA_GENESIS_TIME,
};
...
impl ChainInfo {
    pub fn for_mainnet() -> Self {
        Self {
            ...
            context: ChainSpec::mainnet(),
            clock: mainnet_slot_clock(),
    ...
    pub fn for_sepolia() -> Self {
        Self {
            ...
            context: sepolia_spec(),
            clock: sepolia_slot_clock(),
    ...
    pub fn for_holesky() -> Self {
        Self {
            ...
            context: holesky_spec(),
            clock: holesky_slot_clock(),
