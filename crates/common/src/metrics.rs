...
lazy_static! {
    ...
    pub static ref SUB_TRACE_LATENCY: HistogramVec = register_histogram_vec_with_registry!(
        ...
        &["step"],
        vec![1., 5., 10., 15., 25., 50., 100., 250., 500., 1_000., 1_500., 2_000., 2_500., 3_000., 4_000., 5_000., 10_000., 25_000., 50_000., 100_000., 500_000., 1_000_000., 5_000_000., 10_000_000., 50_000_000., 100_000_000.,],
        &RELAY_METRICS_REGISTRY
    )
    .unwrap();
    ...
    pub static ref GET_PAYLOAD_TRACE_LATENCY: HistogramVec = register_histogram_vec_with_registry!(
        ...
        &["step"],
        vec![1., 5., 10., 25., 50., 100., 250., 500., 1_000., 2_500., 5_000., 10_000., 25_000., 50_000., 100_000., 250_000., 500_000., 750_000., 1_000_000., 1_500_000., 2_000_000., 3_000_000., 5_000_000., 10_000_000.,],
        &RELAY_METRICS_REGISTRY
    )
    .unwrap();
