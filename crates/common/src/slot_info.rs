...
use crate::{
    ...
    beacon::types::PayloadAttributes,
...
/// All information that is refreshed every slot. Thread-safe and cheaply cloneable.
#[derive(Clone)]
...
impl CurrentSlotInfo {
    ...
    pub fn handle_new_slot(&self, slot_update: SlotDuties, chain_info: &ChainInfo) {
