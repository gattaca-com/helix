...
mod tests {
    ...
    fn get_router() -> Router<()> {
        ...
        rate_limits.insert(ROUTE_WITH_LIMIT.to_string(), RateLimitStateForRoute::new(Duration::from_secs(5), 1));
        rate_limits.insert(ROUTE_WITH_HIGH_LIMIT.to_string(), RateLimitStateForRoute::new(Duration::from_secs(10), 10));
