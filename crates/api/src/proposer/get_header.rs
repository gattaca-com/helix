...
impl<A: Api> ProposerApi<A> {
    ...
    pub async fn get_header(
        ...
        let get_best_bid_res = proposer_api.curr_best_header.load(
        ...
        if let Some(bid) = get_best_bid_res {
            ...
            let signed_bid = resign_builder_bid(
                bid,
                &proposer_api.signing_context,
                helix_types::ForkName::Electra, // TODO!!: fix fork
            );
